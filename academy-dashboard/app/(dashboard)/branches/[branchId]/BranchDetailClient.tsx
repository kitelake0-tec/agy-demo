...
export default function BranchDetailClient({ branchId }: { branchId: string }) {
    ...
    const fetchBranchDetail = async () => {
        try {
            ...
            console.log("Using Mock Data for Branch");
            // Mock Fallback
            setBranch({
                id: Number(branchId),
                name: `지점 #${branchId} (Demo)`,
                monthlyKpis: [
                    {
                        id: 1,
                        yearMonth: "2024-01-01",
                        totalRevenue: "45000000",
                        tuitionRevenue: "35000000",
                        consultingRevenue: "10000000",
                        otherRevenue: "0",
