...
이 파일은 `.agent-workspace/interviews/위키시스템` 폴더에 있던 원본 마크다운 파일들의 내용을 그대로 통합하여 저장한 것입니다.

---

## 1. index.md (Client-side HTML/JS)
...
## 2. codes.md (Server-side Google Apps Script)
